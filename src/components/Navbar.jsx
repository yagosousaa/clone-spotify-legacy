    ...
    <aside className="bg-black h-full w-80 overflow-hidden flex flex-col items-center">
      <section className="mr-10">
        <nav className="flex flex-col gap-6 font-regular mb-12 mt-16">
          ...
          <a className="flex gap-6 text-normal items-center font-normal text-zinc-200/60 cursor-pointer hover:text-white group">
            <img
        ...
        <nav className="flex flex-col gap-4">
          <a className="flex gap-5 text-normal items-center font-normal text-zinc-200/60 cursor-pointer hover:text-zinc-200 group">
      ...
      <div className="mr-10 flex flex-col space-y-4 text-normal text-zinc-400">
        <a className="cursor-pointer hover:text-white">Jazz</a>
        <a className="cursor-pointer hover:text-white">Metal</a>
        <a className="cursor-pointer hover:text-white">Indie</a>
        <a className="cursor-pointer hover:text-white">Rock</a>
        <a className="cursor-pointer hover:text-white">Your Top Songs 2023</a>
        <a className="cursor-pointer hover:text-white">Orchestra</a>
      </div>
    </aside>
  );
}
